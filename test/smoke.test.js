...
t.test('exercises/section2/event-handler-error-handling/broken.js', async t => runScript(t.name));
...
t.test('exercises/section2/event-handler-error-handling/still-broken.js', async t => runScript(t.name));
